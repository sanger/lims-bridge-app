...
gem 'lims-laboratory-app', '~>3.6.0', :git => 'http://github.com/sanger/lims-laboratory-app.git' , :branch => 'master'
...
gem 'lims-quality-app', '~>0.8.0', :git => 'https://github.com/sanger/lims-quality-app.git', :branch => 'master'
