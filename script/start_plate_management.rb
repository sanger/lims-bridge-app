...
module Lims
  module BridgeApp
    ...
    consumer = PlateManagementConsumer.new(amqp_settings, bridge_settings)
    consumer.set_logger(Logging::LOGGER)

    Logging::LOGGER.info("Plate management started")
    consumer.start
    Logging::LOGGER.info("Plate management stopped")
  end
end
