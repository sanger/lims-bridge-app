...
module Lims::BridgeApp::PlateCreator
  describe "Swapping samples" do
    ...
    context "circular swap 3 samples" do
      let(:location_samples) {{
        "A1" => "11111111-0000-0000-0000-333333333333",
        "B2" => "11111111-0000-0000-0000-111111111111",
        "C3" => "11111111-0000-0000-0000-222222222222",
        "D4" => "11111111-0000-0000-0000-444444444444" # unchanged
      }}
      let(:swaps) {{
        "11111111-0000-0000-0000-111111111111" => "11111111-0000-0000-0000-333333333333",
        "11111111-0000-0000-0000-222222222222" => "11111111-0000-0000-0000-111111111111",
        "11111111-0000-0000-0000-333333333333" => "11111111-0000-0000-0000-222222222222",
        "11111111-0000-0000-0000-444444444444" => "11111111-0000-0000-0000-111111111111"
      }}

      context "valid" do
        it_behaves_like "sample in location", "11111111-0000-0000-0000-333333333333", "A1"
        it_behaves_like "sample in location", "11111111-0000-0000-0000-111111111111", "B2"
        it_behaves_like "sample in location", "11111111-0000-0000-0000-222222222222", "C3"
        it_behaves_like "sample in location", "11111111-0000-0000-0000-444444444444", "D4"
      end
    end
  end
end
